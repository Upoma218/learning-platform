        ...
        <div className='bg-gray-200'>
            ...
            <div className='pb-24 pt-12'>
                ...
                <div className=' text-center rounded-3xl bg-white mx-12 py-12 mb-12'>
                    ...
                    <p className=' text-gray-800 text-md p-8'>
                ...
                <div className=' text-center rounded-3xl bg-white mx-12 py-12 mb-12'>
                    ...
                    <p className=' text-gray-800 text-md p-8'>The private route component is similar to the public route, the only change is that redirect URL and authenticate condition. If the user is not authenticated he will be redirected to the login page and the user can only access the authenticated routes If he is authenticated Logged in.</p>
                </div>
                <div className=' text-center rounded-3xl bg-white mx-12 py-12 mb-12'>
                    <h1 className='text-yellow-800 text-3xl my-18' >4. What is node: How does node work?</h1>
                    <p className=' text-gray-800 text-md p-8'>It is a used as backend service where javascript works on the server-side of the application. This way javascript is used on both frontend and backend. Node. js runs on chrome v8 engine which converts javascript code into machine code, it is highly scalable, lightweight, fast, and data-intensive.</p>
                </div>
